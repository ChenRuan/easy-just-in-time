/*
 * config_process_base.c
 *
 * Baseline C benchmark for a config-processing loop. This is the non-JIT
 * companion to config_process_easyjit.c so the two can be compared without
 * bringing any product-specific naming into the tree.
 */
...
int main(void) {
    ...
    for (int i = 0; i < LOOP_COUNT; ++i) {
        ...
        sum += process_config(config_index);
    }
