...
int main(void) {
    ...
    /* process(input, scale, a, b, index, offset)
     *   input  -> forward runtime arg #0
     *   scale  -> specialize to constant 2.0
     *   a      -> snapshot struct
     *   b      -> snapshot struct
     *   index  -> specialize to constant 4
     *   offset -> forward runtime arg #1
     */
